...
def train_and_evaluate(seed, n_epochs=300, lr=0.005, patience=30):
    ...
    model = HeteroscedasticDKL(input_dim, feature_dim=16, n_inducing=100).to(device)
...
# 保存完整結果
results_df.to_csv('phase3a_seed_search_results_v2.csv', index=False)
print(f"\n✓ 完整結果已保存至 phase3a_seed_search_results_v2.csv")